        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div data-revelar className="flex flex-col gap-3 sm:flex-row lg:flex-col">
            <a
              ...
              className="inline-flex min-h-14 items-center justify-center gap-2.5 rounded-full bg-amarelo px-8 text-lg font-semibold text-azul-escuro shadow-alta transition-all duration-300 hover:brightness-105"
            >
