          ...
          <div ref={painel} className="anima-etapa mb-7 rounded-lg bg-azul-suave p-5 sm:p-6">
            ...
            {escolha.destino.disponivel ? (
              ...
              <a
                ...
                // Verde, como todo botão de grupo do site: sobre o azul-claro
                // do painel ele salta, e o ícone diz WhatsApp antes do texto.
                // 19px e negrito: branco sobre este verde só passa no
                // contraste como texto grande.
                className="toque mt-5 flex min-h-14 w-full items-center justify-center gap-3 rounded-full bg-verde px-6 py-3 text-left text-[1.1875rem] leading-snug font-bold text-white shadow-media transition-[filter] hover:brightness-110"
              >
                <IconeWhatsApp />
                <span>
